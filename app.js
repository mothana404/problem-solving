...
console.log("you use a method inside a employee object and call and the (this) in console.log refers to the object that have the first name (rawan)");
...
console.log("(this) in the printInfo object is not for the info object it is for the employee itself.");
...
console.log("here in this example it will not give you anything becasue you didnt use console.log to display the result put it the output will be Zarqa");
